...
上式通常又被称为**乘法法则**(product rule)。给定两个事件的**联合概率分布**（joint distribution）<img src="https://latex.codecogs.com/gif.latex?p(A,B)"/>，定义**边缘分布**(marginal distribution)如下: 
