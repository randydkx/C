...
class mainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.width = 400
        self.height = 300
        self.iconName = "/Users/wenshuiluo/Downloads/ML-GUI-using-PyQt5/assets/python.png"
        self.initUI()
    ...
    def getFileName(self):
        fileName, _ = QFileDialog.getOpenFileName(self, 'Single File', '/Users/wenshuiluo/Downloads/ML-GUI-using-PyQt5/scripts' , '*.csv')
